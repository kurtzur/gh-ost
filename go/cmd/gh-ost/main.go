...
func main() {
	...
	exponentialBackoffMaxInterval := flag.Int64("exponential-backoff-max-interval", 64, "Maximum number of seconds to wait attempts when performing various operations with exponential backoff.")
